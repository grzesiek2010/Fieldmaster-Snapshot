...
public class Preview implements SurfaceHolder.Callback, TextureView.SurfaceTextureListener {
	...
	public boolean touchEvent(MotionEvent event) throws FileNotFoundException {
		if( MyDebug.LOG )
	...
	public boolean onDoubleTap() throws FileNotFoundException {
		if( MyDebug.LOG )
    ...
    private void mySurfaceCreated() throws FileNotFoundException {
		this.has_surface = true;
		this.openCamera();
    }
    
    private void mySurfaceDestroyed() throws FileNotFoundException {
    ...
    public void stopVideo(boolean from_restart) throws FileNotFoundException {
		if( MyDebug.LOG )
			Log.d(TAG, "stopVideo()");
	 ...
	 */
	private void restartVideo(boolean due_to_max_filesize) throws FileNotFoundException{
		if( MyDebug.LOG )
	...
	private void reconnectCamera(boolean quiet) throws FileNotFoundException {
		if( MyDebug.LOG )
	...
	private void closeCamera() throws FileNotFoundException {
		long debug_time = 0;
		if( MyDebug.LOG ) {
	 ...
	 */
	public void retryOpenCamera() throws FileNotFoundException {
		if( MyDebug.LOG )
	 ...
	 */
	public void setupCamera(boolean take_photo) throws FileNotFoundException {
		if( MyDebug.LOG )
	...
	public void setCamera(int cameraId) throws FileNotFoundException {
		if( MyDebug.LOG )
			Log.d(TAG, "setCamera()");
		if( cameraId < 0 || cameraId >= camera_controller_manager.getNumberOfCameras() ) {
			if( MyDebug.LOG )
	...
	public void switchVideo(boolean during_startup) throws FileNotFoundException {
		if( MyDebug.LOG )
	 ...
	 */
	public void takePicturePressed() throws FileNotFoundException{
		if( MyDebug.LOG )
	...
	private void onVideoInfo(int what, int extra) throws FileNotFoundException{
		if( MyDebug.LOG )
	...
	private void onVideoError(int what, int extra) throws FileNotFoundException {
		if( MyDebug.LOG )
	...
	private void failedToStartVideoRecorder(CamcorderProfile profile) throws FileNotFoundException {
