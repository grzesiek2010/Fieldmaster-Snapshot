...
public class MyApplicationInterface implements ApplicationInterface {
	...
	void setNextPanoramaPoint() throws FileNotFoundException{
		if( MyDebug.LOG )
	...
	private void setNextPanoramaPoint(float x, float y, float z) throws FileNotFoundException {
		if( MyDebug.LOG )
		...
		gyroSensor.setTarget(x, y, z, target_angle, new GyroSensor.TargetCallback() {
			...
			public void onAchieved()  {
				...
				clearPanoramaPoint();
				try{main_activity.takePicturePressed();}catch (FileNotFoundException e){e.printStackTrace();}
	...
	private void trashImage(boolean image_saf, Uri image_uri, String image_name) throws FileNotFoundException {
		if( MyDebug.LOG )
